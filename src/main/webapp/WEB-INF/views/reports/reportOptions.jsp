...
<div class="container">
    ...
    <div class="text-center">
        <a href="/reports/monthly-employee-report/form"
           class="btn btn-success rounded-0 text-light m-1 btn-report-option">
            <h4>monthly employee report</h4>
        </a>
        <br><br>
        <a href="/reports/project-report/form" class="btn btn-info rounded-0 text-light m-1 btn-report-option">
        ...
        <br><br>
        <a href="/reports/export-timesheets/form" class="btn btn-success rounded-0 text-light m-1 btn-report-option">
